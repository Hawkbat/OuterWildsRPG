...
namespace OuterWildsRPG.Components
{
    public class QuestListStep : BuiltElement
    {
        ...
        public override void Rebuild()
        {
            ...
            optionalLabel.font = QuestHUD.Font;
            ...
            strikethrough.rectTransform.anchoredPosition = new Vector2(ICON_SIZE.x + SPACING, -8f);
        ...
        public override bool Animate()
        {
            if (animateCompletion)
            {
                ...
                var t0 = Mathf.Clamp01(Mathf.InverseLerp(step.CompletedTime, step.CompletedTime + 3f * textRatio, Time.time));
                ...
                var t1 = Mathf.Clamp01(Mathf.InverseLerp(step.CompletedTime + 4f, step.CompletedTime + 5f, Time.time));
            ...
            {
                var t = Mathf.Clamp01(Mathf.InverseLerp(step.StartedTime, step.StartedTime + 1f, Time.time));
            ...
            if (animateCompletion || animateStart)
                questListQuest.TriggerAnimation();

            return animateCompletion || animateStart;
        }
